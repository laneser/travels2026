...
const SHOPPING = {
  ...
  spots: [
    ...
    },
    {
      ...
      day: 5,
      note:
        "買 Shachihata 印泥的據點。注意：Shachihata（シヤチハタ）產品線沒有叫「印泥」的品項——一般海綿朱肉（シヤチハタ朱肉エコス ¥600 起、プチ朱肉 ¥350、速乾款 ¥800 起）任何文具店、Loft、ハンズ都有，不必特地跑高檔文具店；若要的是傳統印泥質感的高級「練朱肉」，對應產品是「鯱旗印肉」系列（書画落款用 ¥3,100／公用 ¥2,200），小文具店通常沒現貨，建議到大型文具賣場（ハンズ心斎橋 11F 文具）請店員查庫存，或退而求其次找印章專門店、書道用品店。就在心斎橋PARCO（與 THE ONITSUKA 高端副線同棟），Day 5 掃鞋順路。同店滿 ¥5,000 可退稅。",
      links: [

  ...
  extraCards: [
    {
      icon: "🎯",
      title: "本趟主題",
      body: "梅雨季優雅吃透關西。以大阪帝國飯店為據點，四個美食重點：① Day 2 黑門市場 + 割烹／河豚 ② Day 3 壽司／鰻魚／串炸三料 ③ Day 4 神戶牛鐵板燒午餐（提前 2 週訂位） ④ Day 5 大阪燒名店 + 和牛燒肉。Day 1、Day 6 留白給道頓堀小吃與早午餐告別。購物：心齋橋筋掃鬼塚虎 Onitsuka Tiger，回程日可加碼關西機場旁 outlet（見「購物」分頁）。",
    },
    {
      icon: "🔒",
      title: "提前預約清單",
